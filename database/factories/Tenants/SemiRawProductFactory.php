...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\Tenants\SemiRawProduct>
 */
class SemiRawProductFactory extends Factory
{
    /**
     ...
     * @var string
     */
    protected $model = SemiRawProduct::class;
